...
class TestRectangle_y(unittest.TestCase):
    ...
    def test_tuple_y(self):
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
OBOB            Rectangle(1, 2, 1, (1, 2, 3))
OB
    def test_frozenset_y(self):
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
OB            Rectangle(1, 2, 3, frozenset({1, 2, 3, 1}))
OBOB
    def test_range_y(self):
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
OB            Rectangle(1, 2, 3, range(5))
OB
    def test_bytes_y(self):
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
OB            Rectangle(1, 2, 3, b'Python')
OB
    def test_bytearray_y(self):
OB        with self.assertRaisesRegex(TypeError, "y must be an integer"):
OB            Rectangle(1, 2, 3, bytearray(b'abcdefg'))
OB
OB    def test_memoryview_y(self):
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
            Rectangle(1, 2, 3, memoryview(b'abcedfg'))

OB    def test_inf_y(self):
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
            Rectangle(1, 2, 1, float('inf'))

OB    def test_nan_y(self):
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
