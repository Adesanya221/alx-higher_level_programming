...
OB        s = Square(10, 10, 10, 10)
        s.update()
        self.assertEqual("[Square] (10) 10/10 - 10", str(s))
OB
OB    def test_update_args_one(self):
OB        s = Square(10, 10, 10, 10)
OB        s.update(89)
OB        self.assertEqual("[Square] (89) 10/10 - 10", str(s))
OB
OB    def test_update_args_two(self):
        s = Square(10, 10, 10, 10)
        s.update(89, 2)
OB        self.assertEqual("[Square] (89) 10/10 - 2", str(s))
OB
...
OB        s.update(89, 2, 3, 4, 5)
    ...
    def test_update_args_invalid_x(self):
        s = Square(10, 10, 10, 10)
        with self.assertRaisesRegex(TypeError, "x must be an integer"):
OBOBOBOB            s.update(89, 1, "invalid")
OBOB
    def test_update_args_x_negative(self):
OBOB        s = Square(10, 10, 10, 10)
        with self.assertRaisesRegex(ValueError, "x must be >= 0"):
OBOBOB            s.update(98, 1, -4)
OBOB
OBOBOB    def test_update_args_invalid_y(self):
OBOB        s = Square(10, 10, 10, 10)
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
OBOBOB            s.update(89, 1, 2, "invalid")
OBOB
    def test_update_args_y_negative(self):
OB        s = Square(10, 10, 10, 10)
        with self.assertRaisesRegex(ValueError, "y must be >= 0"):
OBOB            s.update(98, 1, 2, -4)
OBOB
OB    def test_update_args_size_before_x(self):
        s = Square(10, 10, 10, 10)
...
OB        with self.assertRaisesRegex(TypeError, "width must be an integer"):
    ...
    def test_update_args_x_before_y(self):
        s = Square(10, 10, 10, 10)
OB        with self.assertRaisesRegex(TypeError, "x must be an integer"):
